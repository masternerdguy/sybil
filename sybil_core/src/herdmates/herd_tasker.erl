...
start() ->
    ...
    %% register process
    register(herd_tasker_process, PID),
...
setup_query() ->
    "you are an assistant within a collective consciousness. ".
